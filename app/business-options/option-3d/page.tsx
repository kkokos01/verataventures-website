...
export default function Option3D() {
  ...
  const products = [
    { name: 'Culinova', description: 'AI-powered meal planning for families', status: 'Beta', category: 'Consumer Tech' },
    { name: 'IEP Copilot', description: 'Parent advocacy platform for special education', status: 'Beta', category: 'Education' },
    { name: 'Rare Disease Navigator', description: 'Healthcare navigation for rare diseases', status: 'Development', category: 'Healthcare' },
    { name: 'EMR Platform', description: 'Mental health practice management', status: 'Development', category: 'Healthcare' },
  ]
