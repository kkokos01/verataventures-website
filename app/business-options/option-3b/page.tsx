...
export default function Option3B() {
  ...
  const products = [
    { name: 'Culinova', description: 'AI-powered meal planning for families', letter: 'C', status: 'Beta', color: '#1e3a8a' },
    { name: 'IEP Copilot', description: 'Parent advocacy platform for special education', letter: 'I', status: 'Beta', color: '#0d9488' },
    { name: 'Rare Disease Navigator', description: 'Healthcare navigation for rare diseases', letter: 'R', status: 'Development', color: '#4338ca' },
    { name: 'EMR Platform', description: 'Mental health practice management', letter: 'E', status: 'Development', color: '#475569' },
  ]
